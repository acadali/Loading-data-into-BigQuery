...
Download a subset of NYC from <a href="https://github.com/acadali/Loading-data-into-BigQuery/blob/main/nyc_tlc_yellow_trips_2018_subset_1.csv">here</a>. Select nyctaxi dataset then click **Create Table**.
